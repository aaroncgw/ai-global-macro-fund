...
from app.backend.routes.macro_portfolio import router as macro_portfolio_router
...
api_router.include_router(macro_portfolio_router, prefix="/macro-portfolio", tags=["macro-portfolio"])
